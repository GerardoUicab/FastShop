...
<div class="col-md-8">
<h5 class="text-center" style="color:red;"><b>MI CARRITO</b></h5><br>
...
<?php }?>
<?php if ($carrito['PrecioProduc']==null)echo '<h1>hOLA</h1>';?>
<?php } ?>
</div>
...
<div class="col-md-3 snipcart-details tline-out"><br>
    ...
    <h5 style="color:#00334e;" >&nbsp;&nbsp;  <b>Resumen De Pedido</b></h5><br><br>
        <h5 ><b>SubTotal:</b>
        $<?php echo $resumen['SubTotal']; ?></h5><br>
    <h5 ><b>Costo Envio:</b>&nbsp;&nbsp;
    $<?php echo $resumen['Envio']; ?></h5><br>
    <h5 ><b>Total:</b> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    $<?php echo $resumen['Total']; ?></h5><br><br>
...
<?php } ?>
    ...
    <h3 style="color:red;" class="text-center"><b>NO TIENES PRODUCTOS EN TU CARRITO</b></h3>
    <hr>
    <h6>Empieza a comprar ahora, y ha obtener una mejor experiencia en FastShop</h6>
    <hr>
