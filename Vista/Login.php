                    	...
                    	<div class="tabs-content">
                    		...
                    		<div id="signup-tab-content">
                    			<form class="signup-form" action="Login.php" method="post">
                    				<input type="email" class="input" name="txtEmail" id="user_Email" autocomplete="off" placeholder="Email">
                    				<input type="text" class="input" name="txtNombreUsu" id="user_nombre" autocomplete="off" placeholder="Nombre de usuario">
                    				<input type="password" class="input" name="txtcontraseña" id="user_contraseña" autocomplete="off" placeholder="Contraseña">
                    				<input type="submit" name="btnAceptar" id="btnAceptar" class="button" value="Aceptar">
                    			</form>
